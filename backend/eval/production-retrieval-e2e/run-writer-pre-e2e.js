...
try{
  ...
  const preflight={authorization_status:ready?'READY_FOR_EXPLICIT_AUTHORIZATION':'BLOCKED_PENDING_RUNTIME_CONFIGURATION',data_classification:'REPRESENTATIVE_SYNTHETIC / NOT_REAL_CUSTOMER_DATA',customer_private_data:false,project_id:PROJECT_ID,provider:runtime.provider,model:runtime.model,model_availability:runtime.model_available?'AVAILABLE':'NOT_VERIFIED',endpoint_type:runtime.endpoint_type,endpoint_host:runtime.host||'UNCONFIGURED',response_format:{type:runtime.response_format_mode},mode:runtime.mode,prompt_version:runtime.prompt_version,positive_writer_task_count:1,negative_safety_task_count:negativeTasks.length,positive_tasks:[{...inventory,authorization_chain:chain}],totals:{context_items:inventory.context_items_count,assertable_claims:inventory.assertable_claims_count,safe_context_estimated_tokens:inventory.safe_context_estimated_tokens,provider_request_estimated_characters:inventory.provider_request_estimated_chars,provider_request_estimated_tokens:inventory.provider_request_estimated_tokens,max_output_tokens:runtime.max_output_tokens,expected_external_requests:1,concurrency:runtime.concurrency,retry_policy:'NO_AUTOMATIC_RETRY'},outbound_data_categories:{chapter_instruction:true,writer_task_minimal_metadata:true,current_chapter_safe_context:true,approved_project_fact_structured_values:true,current_assertable_claims:true,evidence_fact_structured_values:true},excluded_data_categories:{customer_private_data:true,evidence_source_span_raw_text:true,material_raw_text:true,full_enterprise_corpus:true,full_tender:true,other_chapters:true,audit_records:true,historical_writer_outputs:true,api_key_in_body:true},logging_policy:{allowed:['provider','model','request_id','writer_task_id','sanitized_request_hash','input_tokens','output_tokens','latency','provider_status','output_identity','finish_reason','response_char_count','response_content_hash','response_format_mode','json_parse_success','schema_validation_success','parse_failure_class','parse_error_offset'],api_key_logged:false,authorization_header_logged:false,full_request_body_logged:false,full_provider_raw_response_logged:false},external_writer_calls_performed:0};
